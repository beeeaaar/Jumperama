...
namespace JumpGame
{
    public partial class Form1 : Form
    {
        ...
        public Form1()
        {
            ...
            timer1.Start();
            this.KeyDown += new KeyEventHandler(OnKeyboardPreseed);
        ...
        private void OnKeyboardPreseed(object sender, KeyEventArgs e)
        {
        ...
        {
            this.Text = "Jumperama: Score - " + PlatformController.score;
